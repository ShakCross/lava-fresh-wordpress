	...
	*/
	...
	$(function() {
		...
		function init() {
			...
			$(document.body).off( 'vclick', addToCartBtn.selector);
		...
		function removeUnwantedElements() {
			...
			cartBody.find('.woocommerce-cart-form').remove();
        ...
        $(function() {
			...
			if(XT_WOOFC.can_use_premium_code) {
                ...
                if (top && typeof(top.wp) !== 'undefined' && typeof(top.wp.customize) !== 'undefined' && typeof(top.wp.customize.preview) !== 'undefined') {
