...
var $document = $(document),
	...
	plugins = {
		...
		couponCarousel: $('.coupon-carousel'),
...
$document.ready(function () {
	...
	// coupon carousel
	if (plugins.couponCarousel.length) {
		plugins.couponCarousel.slick({
			slidesToShow: 3,
			slidesToScroll: 3,
			dots: true,
			infinite: true,
	...
	$window.on('load', function () {
		...
		function createMap(id, mapZoom) {
			...
			var image = '../src/assets/img/map-marker.png';
